...
export default function Header() {
  ...
  const [showQxSubNav, setShowQxSubNav] = useState(false);
  ...
  useEffect(() => {
    ...
    console.log("Metamask connectors:", metamaskConnectors);

    if (metamaskConnectors.length > 0) {
      setIsMetamask(true)
    }
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-4 items-center">
              ...
              <li>
                <button
                  onClick={() => setShowQxSubNav(!showQxSubNav)}
        ...
        <div className="bg-gray-700">
          <div className="container mx-auto flex justify-end">
            <ul className="flex space-x-4 py-2">
              <li>
                <Link href="/qx-assets" className="text-white hover:underline">
                  {t("qx.title")}
                </Link>
              </li>
              <li>
                <Link href="/qx-trades" className="text-white hover:underline">
                  {t("qx.trades")}
                </Link>
              </li>
              <li>
                <Link href="/qx-transactions" className="text-white hover:underline">
                  {t("qx.transactions")}
                </Link>
              </li>
            </ul>
